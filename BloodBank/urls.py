...
from .views import ChangePasswordResetDoneSuccessView, ChangePasswordResetDoneView, PasswordResetView, DonorUpdateView, donorlist, PasswordResetCompleteView, PasswordResetDoneView, PasswordResetConfirmView, BloodAvailableUpdateView, BloodAvailableDeleteView, blood_storage
